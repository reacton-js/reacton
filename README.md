...
Свойство **$host** всегда ссылается на компонент. Специальные свойства, как и пользовательские, не требуют добавления перед ними ключевого слова **this** в выражениях, о чём свидетельствует представленный выше пример.
