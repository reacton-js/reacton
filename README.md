...
В Reacton это делается с помощью определения свойства [mode](#mode) в экспортируемом объекте компонента. Данное свойство может иметь значение "open" или "closed" и, кроме этого, его нельзя использовать с модифицированными при помощи свойства [extends](#extends) компонентами.
