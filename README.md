...
Мы плавно подходим к завершению руководства по Reacton, осталось рассмотреть две последние темы, и можно будет приступать к созданию полноценного приложения и последующего этому, серверному рендерингу.
...
Здесь на помощь приходит реализованная в Reacton технология Наблюдателя. В обобщённом смысле, [технология](https://learn.javascript.ru/dispatch-events#polzovatelskie-sobytiya) пользовательских событий реализована в самом JavaScript, а Reacton лишь немного делает её лучше.
